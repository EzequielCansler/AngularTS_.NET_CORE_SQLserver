...
- Create Angular project with ng: `ng new manejoinventario_angularts_.net_core.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`manejoinventario_angularts_.net_core.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `manejoinventario_angularts_.net_core.client.esproj`).
